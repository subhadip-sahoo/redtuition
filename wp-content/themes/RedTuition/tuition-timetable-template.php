<?php /* Template Name: Tuition Time Table */ ?>
...
<section class="wrapper">
    <section class="contener inner-pages">
        ...
        ?>
        <div class="table_div">
            <?php query_posts(array('post_type' => 'tuition-class-times', 'posts_per_page' => -1, 'order' => 'ASC')); ?>
            <?php if(have_posts()): ?>
            <?php while(have_posts()): the_post(); $count = 0;?>
            <table class="time-table" width="100%" cellspacing="5" cellpadding="5">
                <tbody>
                    <tr class="heading">
                        <td colspan="8"><?php echo get_field('heading');?></td>
                    </tr>
                    <tr class="sub-heading">
                        <td colspan="8" align="center"><?php the_title(); ?></td>
                    </tr>
                    <?php 
