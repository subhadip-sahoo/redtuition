...
$client_app= get_post_meta($g_event_id,'hangout_InfusionSoft_app',true);
$client = new xmlrpc_client("https://$client_app.infusionsoft.com/api/xmlrpc"); 
###Return Raw PHP Types###
$client->return_type = "phpvals";
###Dont bother with certificate verification###
$client->setSSLVerifyPeer(FALSE);
###Our API Key###
$key = get_post_meta($g_event_id,'hangout_InfusionSoft_list_id',true);
